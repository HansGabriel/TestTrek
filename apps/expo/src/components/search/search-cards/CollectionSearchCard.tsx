...
import { ReturnedAlgoliaCollections } from "../../../types/algoliaTypes";

const CollectionSearchCard: FC<ReturnedAlgoliaCollections> = (props) => {
  return (
    <SafeAreaView>
      <View className="w-[90%] flex-row items-center justify-between gap-4 px-3 py-3">
        ...
        <View className="h-[29%] w-[21%] items-center justify-center rounded-lg border-2 border-gray-400 bg-gray-400">
